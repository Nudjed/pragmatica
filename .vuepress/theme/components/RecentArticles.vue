  ...
  <section class="py-8 bg-white">
    <div class="container sm:mx-auto sm:flex sm:flex-wrap font-serif font-semibold">
      <div class="w-1/4 p-4 sm:max-w-xs my-4">
        <h3 class="text-blue text-left mb-3 text-3xl">Projects &amp; insights.</h3>

        <p
          class="text-green font-sans-serif font-medium text-left text-base"
        >Pragmatica brings a fresh approach to consulting through investing in our partnerships with clients and sharing in the value we help create.</p>
