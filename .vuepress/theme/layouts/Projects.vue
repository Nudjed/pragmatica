<template>
  <div class="font-sans-serif text-smooth bg-white antialiased leading-normal">
    <div class="bg-blue">
      <div style="background-image: url('/globalmap.svg');" class="container mx-auto h-full bg-center bg-cover bg-no-repeat">
        <header class="text-white pb-8 mb-8">
          ...
          <p class="font-sans-serif font-medium text-lg max-w-xs py-6 pb-8 mb-8">{{ this.$page.frontmatter.description
            }}</p>
        </header>
      </div>
    </div>
